...
public class AttendanceController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public AttendaceDTO getAttendanceByParticipantIdAndActivityId(String participantId, String activityId)
            throws NotFoundException {
        return attendanceMapper
                .toAttendaceDTO(attendanceService.getAttendanceByParticipantIdAndActivityId(participantId, activityId));
    }
